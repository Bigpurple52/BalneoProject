...
/*****************************************************
* 
* Edit� par tibeoh pour le site du zero 
...
class GoogleMapAPI {
    ...
    var $driving_dir_text = array(
            'dir_to' => 'Adresse de d�part: (Adresse, ville et pays)',
            'to_button_value' => 'Itin�raire',
            'to_button_type' => 'submit',
            'dir_from' => "Adresse d\'arriv�e: (Adresse, ville et pays)",
            'from_button_value' => "Itin�raire",
            'from_button_type' => 'submit',
            'dir_text' => 'Itin�raire : ',
            'dir_tohere' => "Jusqu\'� ici",
            'dir_fromhere' => "D\'ici"
            );             
